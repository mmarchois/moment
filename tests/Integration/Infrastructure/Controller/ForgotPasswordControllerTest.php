...
final class ForgotPasswordControllerTest extends AbstractWebTestCase
{
    public function testForgotPassword(): void
    {
        ...
        $this->assertResponseStatusCodeSame(200);
        $this->assertSame('Si cette adresse e-mail est enregistrée chez moment, vous recevrez un lien pour réinitialiser votre mot de passe.', $crawler->filter('div.alert--success')->text());
