...
final class EditProfileControllerTest extends AbstractWebTestCase
{
    ...
    public function testBadValues(): void
    {
        ...
        $crawler = $client->submit($form);
        $this->assertResponseStatusCodeSame(422);
        $this->assertSame('La mission de moment étant de contribuer au “mieux vieillir”, la plateforme est réservée aux plus de 55 ans.', $crawler->filter('#profile_form_birthday_error')->text());
    }
